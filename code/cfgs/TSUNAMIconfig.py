...
BASE_PATH = '/media/siddhant/DATA/birds/sop/SceneChangeDet/'
PRETRAIN_MODEL_PATH = os.path.join(BASE_PATH,'pretrain/tsunami.pth')
DATA_PATH = '/media/siddhant/DATA/birds/sop/SceneChangeDet/datasets/dataset_/TSUNAMI'
...
SAVE_PATH = '/media/siddhant/DATA/birds/sop/SceneChangeDet/TSUNAMI'
